 ...
 */
class type_plat extends \CaroGFaimBundle\Entity\type_plat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CaroGFaimBundle\\Entity\\type_plat' . "\0" . 'id', '' . "\0" . 'CaroGFaimBundle\\Entity\\type_plat' . "\0" . 'libelle', '' . "\0" . 'CaroGFaimBundle\\Entity\\type_plat' . "\0" . 'plats');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (type_plat $proxy) {
