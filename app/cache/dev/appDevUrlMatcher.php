    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/categorie')) {
            ...
            if (rtrim($pathinfo, '/') === '/categorie') {
                ...
                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\categorieController::indexAction',  '_route' => 'categorie_index',);
            }
            not_categorie_index:
            ...
            if (preg_match('#^/categorie/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'categorie_show')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\categorieController::showAction',));
            }
            not_categorie_show:
            ...
            if ($pathinfo === '/categorie/new') {
                ...
                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\categorieController::newAction',  '_route' => 'categorie_new',);
            }
            not_categorie_new:
            ...
            if (preg_match('#^/categorie/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'categorie_edit')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\categorieController::editAction',));
            }
            not_categorie_edit:
            ...
            if (preg_match('#^/categorie/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'categorie_delete')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\categorieController::deleteAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/ingredient')) {
            ...
            if (rtrim($pathinfo, '/') === '/ingredient') {
                ...
                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\ingredientController::indexAction',  '_route' => 'ingredient_index',);
            }
            ...
            if (preg_match('#^/ingredient/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ingredient_show')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\ingredientController::showAction',));
            }
            not_ingredient_show:
            ...
            if ($pathinfo === '/ingredient/new') {
                ...
                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\ingredientController::newAction',  '_route' => 'ingredient_new',);
            }
            not_ingredient_new:
            ...
            if (preg_match('#^/ingredient/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ingredient_edit')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\ingredientController::editAction',));
            }
            not_ingredient_edit:
            ...
            if (preg_match('#^/ingredient/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ingredient_delete')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\ingredientController::deleteAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/personne')) {
            // personne_index
            if (rtrim($pathinfo, '/') === '/personne') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_personne_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'personne_index');
                }

                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\personneController::indexAction',  '_route' => 'personne_index',);
            }
            not_personne_index:

            // personne_show
            if (preg_match('#^/personne/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_personne_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'personne_show')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\personneController::showAction',));
            }
            not_personne_show:
            ...
            if ($pathinfo === '/personne/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_personne_new;
                }

                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\personneController::newAction',  '_route' => 'personne_new',);
            }
            not_personne_new:

            // personne_edit
            if (preg_match('#^/personne/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_personne_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'personne_edit')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\personneController::editAction',));
            }
            not_personne_edit:

            // personne_delete
            if (preg_match('#^/personne/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_personne_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'personne_delete')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\personneController::deleteAction',));
            }
            not_personne_delete:

        }

        if (0 === strpos($pathinfo, '/diner')) {
            // diner_index
            if (rtrim($pathinfo, '/') === '/diner') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_diner_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'diner_index');
                }

                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\dinerController::indexAction',  '_route' => 'diner_index',);
            }
            not_diner_index:

            // diner_show
            if (preg_match('#^/diner/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_diner_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'diner_show')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\dinerController::showAction',));
            }
            not_diner_show:

            // diner_new
            if ($pathinfo === '/diner/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_diner_new;
                }

                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\dinerController::newAction',  '_route' => 'diner_new',);
            }
            not_diner_new:

            // diner_edit
            if (preg_match('#^/diner/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_diner_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'diner_edit')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\dinerController::editAction',));
            }
            not_diner_edit:

            // diner_delete
            if (preg_match('#^/diner/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_diner_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'diner_delete')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\dinerController::deleteAction',));
            }
            not_diner_delete:
        ...
        if (0 === strpos($pathinfo, '/plat')) {
            ...
            if (rtrim($pathinfo, '/') === '/plat') {
                ...
                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\platController::indexAction',  '_route' => 'plat_index',);
            }
            not_plat_index:

            // plat_show
            if (preg_match('#^/plat/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_plat_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'plat_show')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\platController::showAction',));
            }
            not_plat_show:

            // plat_new
            if ($pathinfo === '/plat/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_plat_new;
                }

                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\platController::newAction',  '_route' => 'plat_new',);
            }
            not_plat_new:
            ...
            if (preg_match('#^/plat/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'plat_edit')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\platController::editAction',));
            }
            not_plat_edit:

            // plat_delete
            if (preg_match('#^/plat/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_plat_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'plat_delete')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\platController::deleteAction',));
            }
            not_plat_delete:

            // plat_vote
            if (preg_match('#^/plat/(?P<id>[^/]++)/vote$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_plat_vote;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'plat_vote')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\platController::voteAction',));
            }
            not_plat_vote:

        }

        if (0 === strpos($pathinfo, '/type_plat')) {
            // type_plat_index
            if (rtrim($pathinfo, '/') === '/type_plat') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_type_plat_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'type_plat_index');
                }

                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\type_platController::indexAction',  '_route' => 'type_plat_index',);
            }
            not_type_plat_index:

            // type_plat_show
            if (preg_match('#^/type_plat/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_type_plat_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'type_plat_show')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\type_platController::showAction',));
            }
            not_type_plat_show:

            // type_plat_new
            if ($pathinfo === '/type_plat/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_type_plat_new;
                }

                return array (  '_controller' => 'CaroGFaimBundle\\Controller\\type_platController::newAction',  '_route' => 'type_plat_new',);
            }
            not_type_plat_new:

            // type_plat_edit
            if (preg_match('#^/type_plat/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_type_plat_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'type_plat_edit')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\type_platController::editAction',));
            }
            not_type_plat_edit:

            // type_plat_delete
            if (preg_match('#^/type_plat/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_type_plat_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'type_plat_delete')), array (  '_controller' => 'CaroGFaimBundle\\Controller\\type_platController::deleteAction',));
            }
            not_type_plat_delete:

        }

        // caro_g_faim_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'caro_g_faim_homepage');
            }

            return array (  '_controller' => 'CaroGFaimBundle\\Controller\\DefaultController::indexAction',  '_route' => 'caro_g_faim_homepage',);
        }
